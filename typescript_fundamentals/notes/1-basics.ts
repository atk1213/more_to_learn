...
// no initial definition (just initializing the variable), automatically sets the type to "any"
...
// not defining a type for an array sets it to type: never
// if there is at least one element in the array, it would assume what type it is based on that element
